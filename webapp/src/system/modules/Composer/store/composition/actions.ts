...
export const addMaterialType = createAction<{
  compositionName: string;
  materialType: string;
}>(`[${MODULE_NAME}:Compositions:${ACTION_TYPES.COMMAND}] Add material type`);
export const changeMaterial = createAction<{
  compositionName: string;
...
export const addToBudget = createAction<{
  compositionName: string;
  budgetId: string;
  gradesInfo: string[];
}>(`[${MODULE_NAME}:Compositions:${ACTION_TYPES.COMMAND}] Add to budget`);
export const addGradeToBudget = createAction<{
  compositionName: string;
  budgetId: string;
  gradeId: string;
}>(`[${MODULE_NAME}:Compositions:${ACTION_TYPES.COMMAND}] Add grade to budget`);
export const changeGradeCounter = createAction<{
  compositionName: string;
  gradeId: string;
  counter: number;
}>(
...
export const materialChanged = createAction<{
  compositionName: string;
  materialUsageId: string;
  materialId: string;
...
export const restrictionAdded = createAction<{
  compositionName: string;
  materialId: string;
  restrictionId: string;
}>(`[${MODULE_NAME}:Compositions:${ACTION_TYPES.EVENT}] Restriction added`);
export const restrictionDeleted = createAction<{
  compositionName: string;
  materialId: string;
  restrictionId: string;
}>(`[${MODULE_NAME}:Compositions:${ACTION_TYPES.EVENT}] Restriction deleted`);
export const restrictionUpdated = createAction<{
  compositionName: string;
  materialId: string;
  restrictionId: string;
}>(`[${MODULE_NAME}:Compositions:${ACTION_TYPES.EVENT}] Restriction updated`);

export const debugViewportOpened = createAction<{
  compositionName: string;
  viewportName: string;
}>(`[${MODULE_NAME}:Compositions:${ACTION_TYPES.EVENT}] Debug viewport opened`);
export const debugViewportClosed = createAction<{
  compositionName: string;
  viewportName: string;
}>(`[${MODULE_NAME}:Compositions:${ACTION_TYPES.EVENT}] Debug viewport closed`);
export const addedToBudget = createAction<{
  compositionName: string;
  budgetId: string;
}>(`[${MODULE_NAME}:Compositions:${ACTION_TYPES.EVENT}] Added to budget`);

export const gradeAddedToBudget = createAction<{
  compositionName: string;
  budgetId: string;
  gradeId: string;
}>(`[${MODULE_NAME}:Compositions:${ACTION_TYPES.EVENT}] Grade added to budget`);
export const gradeCounterChanged = createAction<{
  compositionName: string;
  gradeId: string;
  counter: number;
