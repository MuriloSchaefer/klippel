...
import { editProcessTool } from '@system/modules/Composer/mcpTools/editProcess';
import { editProcessShortcutTool } from '@system/modules/Composer/mcpTools/editProcessShortcut';
