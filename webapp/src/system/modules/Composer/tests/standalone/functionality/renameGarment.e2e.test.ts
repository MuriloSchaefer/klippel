...
import { renameGarmentTool } from '@system/modules/Composer/mcpTools/renameGarment';
import { renameGarmentShortcutTool } from '@system/modules/Composer/mcpTools/renameGarmentShortcut';
