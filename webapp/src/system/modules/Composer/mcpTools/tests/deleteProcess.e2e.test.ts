/**
 * E2E tests for deleteProcess + deleteProcessShortcut. Skips if CDP unreachable.
 */
...
beforeAll(async () => {
  ...
  await resetWorkspace(page, 'e2e-processes-delete');
...
afterAll(async () => {
  ...
  cleanupWorkspace('e2e-processes-delete');
});

describe('deleteProcess via click (E2E)', () => {
  it('deletes a process by label', async () => {
...
describe('deleteProcess via shortcut (E2E)', () => {
  it('deletes a process by focusing its row and pressing d', async () => {
