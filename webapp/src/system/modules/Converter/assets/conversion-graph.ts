...
const graph: GraphState<ConversionNodes, ConvertionEdges> = {
  ...
  adjacencyList: {
    ...
    segundos248: {
      inputs: ["minutos249-[conv]->segundos248"],
    ...
    dia251: {
      inputs: ["hora250-[conv]->dia251", "semana253-[conv]->dia251"],
      outputs: ["dia251 -> temporal247", "dia251-[conv]->semana253"],
    },
    mes252: {
      inputs: ["semana253-[conv]->mes252"],
      outputs: ["mes252 -> temporal247", "mes252-[conv]->semana253"],
    },
    semana253: {
      inputs: ["dia251-[conv]->semana253", "mes252-[conv]->semana253"],
      outputs: [
        "semana253 -> temporal247",
        "semana253-[conv]->dia251",
        "semana253-[conv]->mes252",
