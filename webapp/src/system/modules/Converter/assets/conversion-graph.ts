...
const graph: GraphState<ConversionNodes, ConvertionEdges> = {
  ...
  adjacencyList: {
    ...
    segundos248: {
      ...
      outputs: ["segundos248 -> temporal247"],
    },
    minutos249: {
      inputs: ["un / min->minutos249", "hora250-[conv]->minutos249"],
      outputs: ["minutos249 -> temporal247", "minutos249-[conv]->segundos248"],
    },
    hora250: {
      inputs: ["R$ / h->hora250", "un / h->hora250", "dia251-[conv]->hora250"],
      outputs: ["hora250 -> temporal247", "hora250-[conv]->minutos249"],
    },
    dia251: {
      inputs: ["semana253-[conv]->dia251"],
      outputs: ["dia251 -> temporal247", "dia251-[conv]->hora250"],
    },
    mes252: {
      inputs: ["semana253-[conv]->mes252"],
      outputs: ["mes252 -> temporal247"],
    },
    semana253: {
      inputs: [],
      outputs: [
    ...
    "R$ / h": {
      inputs: [],
      outputs: ["R$ / h->reais11", "R$ / h->hora250"],
    },
    "R$ / un": {
      inputs: [],
      outputs: [
